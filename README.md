...
2. compare outputs between TCR-seq and RNA-seq, which sequencing method perform better in cancer diagnosis and why, please summarize (dis)advantages of both sequencing methods.
